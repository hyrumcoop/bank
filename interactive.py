...
from player import BankPlayer, RandomPlayer, HumanPlayer, OpTwoPlayer, NPotPlayer, NDoublesPlayer
...
if __name__ == '__main__':
    players: list[BankPlayer] = [HumanPlayer(), RandomPlayer(), NDoublesPlayer(3), NPotPlayer(200)]
    total_rounds = 3
